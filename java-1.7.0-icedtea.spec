...
%define icedteaver %{icedteabranch}.27
...
%define corbachangeset 0c6b378b7cca
%define jaxpchangeset 3eca1e99be45
%define jaxwschangeset 8403bb591613
%define jdkchangeset 3bad247802a8
%define langtoolschangeset 15a80e2bfc56
%define openjdkchangeset 686390eb64db
%define hotspotchangeset d1f36b3aa16b
...
%changelog
* Mon Aug 02 2021 Andrew Hughes <gnu.andrew@redhat.com> - 1:2.6.27-0
- Update to 2.6.27.

* Sat Jul 03 2021 Andrew Hughes <gnu.andrew@redhat.com> - 1:2.6.26-0
- Update to 2.6.26.

* Fri Feb 12 2021 Andrew Hughes <gnu.andrew@redhat.com> - 1:2.6.25-0
- Update to 2.6.25.

* Thu Nov 05 2020 Andrew Hughes <gnu.andrew@redhat.com> - 1:2.6.24-0
- Update to 2.6.24.

* Fri Sep 25 2020 Andrew Hughes <gnu.andrew@redhat.com> - 1:2.6.23-0
- Update to 2.6.23.

* Thu Apr 16 2020 Andrew John Hughes <gnu.andrew@redhat.com> - 1:2.6.22-0
- Update to 2.6.22.
...
* Tue Apr 30 2019 Andrew John Hughes <gnu.andrew@redhat.com> - 1:2.6.18-0
- Update to 2.6.18.

* Fri Mar 15 2019 Andrew John Hughes <gnu.andrew@redhat.com> - 1:2.6.17-0
- Update to 2.6.17.
...
* Sat May 19 2018 Andrew John Hughes <gnu.andrew@redhat.com> - 1:2.6.14-0
- Update to 2.6.14pre01.

* Tue Feb 27 2018 Andrew John Hughes <gnu.andrew@redhat.com> - 1:2.6.13-0
- Update to 2.6.13.
...
* Tue May 16 2017 Andrew John Hughes <gnu.andrew@redhat.com> - 1:2.6.10-1
- Update to 2.6.10.

* Fri Apr 28 2017 Andrew John Hughes <gnu.andrew@redhat.com> - 1:2.6.10-0
- Update to 2.6.10pre01.

* Fri Apr 14 2017 Andrew Hughes <gnu.andrew@redhat.com> - 1:2.6.9-2
- Add blacklisted.certs to list of config files.

* Mon Feb 13 2017 Andrew John Hughes <gnu.andrew@redhat.com> - 1:2.6.9-2
- Update to 2.6.9.

* Tue Feb 07 2017 Andrew Hughes <gnu.andrew@redhat.com> - 1:2.6.9-1
...
* Sun Nov 13 2016 Andrew John Hughes <gnu.andrew@redhat.com> - 1:2.6.8-1
- Update to 2.6.8.
...
* Tue Jul 21 2015 Andrew John Hughes <gnu.andrew@redhat.com> - 1:2.6.1-0
- Update to 2.6.1
